...
### `replace_fixed_values()`

Some NIRS devices or recording software can report specific invalid values, such as `c(0, 100, 102.3)`. These can be manually removed with `replace_fixed_values()`. See `?replace_fixed_values` for details.
