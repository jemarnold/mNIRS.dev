...
numericInput("sample_rate", label = "Sample Rate", value = 1)

numericInput("resample_rate", label = "Resample Rate", value = 0)
...
output$nirs_table <- DT::renderDT({
    ...
    #         across(
    #             any_of(nirs_columns), 
    #             \(.x) mNIRS::signif_trailing(.x, 3, "signif"))
    #     )
...
output$download_data <- downloadHandler(
    ...
    filename = function() {
        glue("mNIRS_processed_{Sys.time()}.xlsx")
    },
